...
let s:sexp_mappings = {
    ...
    \ 'sexp_flow_to_prev_element_head': '<M-C-b>',
    \ 'sexp_flow_to_next_element_head': '<M-C-w>',
    \ 'sexp_flow_to_prev_element_tail': '<M-C-g>',
    \ 'sexp_flow_to_next_element_tail': '<M-C-e>',
...
" Element flow commands
DefplugN  nnoremap sexp_flow_to_prev_element_head sexp#element_flow('n', v:count, 0, 0)
DEFPLUG   xnoremap sexp_flow_to_prev_element_head <Esc>:<C-u>call sexp#element_flow('v', v:prevcount, 0, 0)<CR>
DefplugN  nnoremap sexp_flow_to_next_element_head sexp#element_flow('n', v:count, 1, 0)
DEFPLUG   xnoremap sexp_flow_to_next_element_head <Esc>:<C-u>call sexp#element_flow('v', v:prevcount, 1, 0)<CR>
DefplugN  nnoremap sexp_flow_to_prev_element_tail sexp#element_flow('n', v:count, 0, 1)
DEFPLUG   xnoremap sexp_flow_to_prev_element_tail <Esc>:<C-u>call sexp#element_flow('v', v:prevcount, 0, 1)<CR>
DefplugN  nnoremap sexp_flow_to_next_element_tail sexp#element_flow('n', v:count, 1, 1)
DEFPLUG   xnoremap sexp_flow_to_next_element_tail <Esc>:<C-u>call sexp#element_flow('v', v:prevcount, 1, 1)<CR>
