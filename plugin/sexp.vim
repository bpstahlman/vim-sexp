...
let s:sexp_mappings = {
    ...
    \ 'sexp_jump_backward_to_comment_subword_in_FORM':  '<Space>:',
    \ 'sexp_jump_forward_to_comment_subword_in_FORM':   '<Space>;',
    ...
    \ 'sexp_jump_backward_to_comment_subword_in_form':  '<C-Space>:',
    \ 'sexp_jump_forward_to_comment_subword_in_form':   '<C-Space>;',
...
function! s:sexp_create_mappings()
    ...
    if !empty(mapcheck('<Plug>(easymotion-jumptoanywhere)'))
        for plug in ['sexp_jump_backward_to_word_in_FORM',              'sexp_jump_forward_to_word_in_FORM',
                   ...
                   \ 'sexp_jump_backward_to_comment_subword_in_FORM',   'sexp_jump_forward_to_comment_subword_in_FORM',
...
Defplug   nnoremap sexp_jump_backward_to_comment_subword_in_FORM sexp#jump_to_target('n', v:count, ';', 0, 1)
DEFPLUG   xnoremap sexp_jump_backward_to_comment_subword_in_FORM <Esc>:<C-u>call sexp#jump_to_target('v', v:prevcount, ';', 0, 1)<CR>
Defplug   nnoremap sexp_jump_forward_to_comment_subword_in_FORM sexp#jump_to_target('n', v:count, ';', 1, 1)
DEFPLUG   xnoremap sexp_jump_forward_to_comment_subword_in_FORM <Esc>:<C-u>call sexp#jump_to_target('v', v:prevcount, ';', 1, 1)<CR>
...
Defplug   nnoremap sexp_jump_backward_to_comment_subword_in_form sexp#jump_to_target('n', v:count, ';', 0, 0)
DEFPLUG   xnoremap sexp_jump_backward_to_comment_subword_in_form <Esc>:<C-u>call sexp#jump_to_target('v', v:prevcount, ';', 0, 0)<CR>
Defplug   nnoremap sexp_jump_forward_to_comment_subword_in_form sexp#jump_to_target('n', v:count, ';', 1, 0)
DEFPLUG   xnoremap sexp_jump_forward_to_comment_subword_in_form <Esc>:<C-u>call sexp#jump_to_target('v', v:prevcount, ';', 1, 0)<CR>
